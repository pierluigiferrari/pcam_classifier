...
class Standardize:
    '''
    Centers and/or normalizes the pixel intensity values of images.

    Important:
        - Expects RGB input.
    '''
    def __init__(self, subtrahend=127.5, divisor=127.5):
        self.subtrahend = subtrahend
        self.divisor = divisor

    def __call__(self, image):
        return (image - self.subtrahend) / self.divisor
...
class RandomSaturation:
    ...
    def __call__(self, image):
        ...
        if p >= (1.0-self.prob):
            ...
            return self.change_saturation(image)
        else:
            return image
...
class Brightness:
    ...
    def __call__(self, image):
        return np.clip(image + self.delta, 0, 255)
...
class RandomBrightness:
    ...
    def __call__(self, image):
        ...
        if p >= (1.0-self.prob):
            ...
            return self.change_brightness(image)
        else:
            return image
...
class Contrast:
    ...
    def __call__(self, image):
        return np.clip(127.5 + self.factor * (image - 127.5), 0, 255)
...
class RandomContrast:
    ...
    def __call__(self, image):
        ...
        if p >= (1.0-self.prob):
            ...
            return self.change_contrast(image)
        else:
            return image
...
class RandomChannelSwap:
    ...
    def __call__(self, image):
        ...
        if p >= (1.0-self.prob):
            ...
            return self.swap_channels(image)
        else:
            return image
